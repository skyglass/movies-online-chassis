package net.chrisrichardson.liveprojects.servicechassis.distributedtracing

import io.restassured.RestAssured.get
import io.restassured.RestAssured.given
import net.chrisrichardson.liveprojects.servicechassis.testcontainers.DefaultPropertyProvidingContainer
import net.chrisrichardson.liveprojects.servicechassis.testcontainers.ZipkinContainer
...
class DistributedTracingTest {
    ...
    fun shouldRecordTrace() {
        ...
        Eventually.withConfiguration(iterations=100) {
        ...
        whenever(accountService.findAccount(accountId)).thenReturn(AccountServiceCommandResult.Success(account))
